...
const WomenPage = () => {
    ...
    const [cart, setCart] = useState(JSON.parse(localStorage.getItem('womenCart')) || []);
                    ...
                    <div className={`filters-container ${filtersActive ? 'active' : ''}`}>
                        ...
                        <div className="filter-group">
                            ...
                            >
                                ...
                                <option value="elegance">Elegance Collection</option>
                                <option value="chic">Chic Line</option>
                                <option value="contemporary">Contemporary Style</option>
                            </select>
                        </div>
                ...
                <div className="section-container">
                    <div className="products-header">
                        <div className="products-info">
                            <h2>Elegant Women's Collection</h2>
