...
const AppliancesPage = () => {
    ...
    const handleAddToCart = (product, color = selectedColor) => {
        addToCart({
            ...product,
            selectedColor: color
        });
    ...
    const getBadgeClass = (tags) => {
        ...
        if (tags.includes('smart')) return 'smart';
    ...
    const brands = [...new Set(appliancesProducts.map(p => p.specifications.brand.toLowerCase()))];
    const categories = [...new Set(appliancesProducts.map(p => p.subcategory))];
                            ...
                            <div className="modal-details">
                                ...
                                <div className="modal-actions">
                                    <button 
                                        className="btn btn-primary"
                                        onClick={() => {
                                            handleAddToCart(quickViewProduct, selectedColor);
                                            closeQuickView();
                                        }}
                                    >
                                        <ShoppingCart size={18} />
